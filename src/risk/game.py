...
class Game(object):
    ...
    def has_won(self, player_id):
        ...
        return self.is_alive(player_id) and (
            self.missions[player_id].evaluate(self.board)
            or self.board.n_territories(player_id) == 42
        )
